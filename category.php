...
//echo $cat."<br/>";
if(isset($str['m'])){$m=$str['m'];//echo $m."<br/>"; 
}

if(isset($str['y'])){$y=$str['y']; //echo $y."<br/>";
}

if(isset($str['t'])){$t=$str['t'];//echo $t."<br/>";
}
...
elseif($type==6){
	$sql_condition=" order BY year, month ASC";
	//echo "<script>alert('".$sql_condition."');</script>";
	}
elseif($type==7){$sql_condition=" order BY year, month DESC";
//echo "<script>alert('".$sql_condition."');</script>";
}
...
<form class="bd-search hidden-sm-down">
    ...
    <div class="container mb-4">
		...
		<br/>
		<div class="row">
		<form  id="myform" action="sort_and_filter.php" method="post"> 
...
<input id="type_input" name="type_input" style="display:none;" value="<?php if(isset($_GET["t"])){echo $_GET["t"];} else{echo "null";} ?>"></input>
