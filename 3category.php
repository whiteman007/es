...
<form class="bd-search hidden-sm-down">
  ...
  <div class="container-fluid">
    		...
    		<nav class="navbar navbar-expand-lg navbar-light bg-white pl-2 pr-2">
    		<button class="navbar-light navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExplore" aria-controls="" aria-expanded="false" aria-label="Toggle navigation">
    		<span class="navbar-toggler-icon"></span>
    		</button>
    		<div class="collapse navbar-collapse" >
			<div class="cd-tab-filter-wrapper">
			<div id="notification-event" class="cd-tab-filter">
    			<ul class="collapse navbar-collapse" id="navbarsExplore">

					<li class="filter" data-filter=".color-2"></li>
					
				
					
					<i style="font-size:24px" class="fa"><a href="#">&#xf0d7;</a> <!--<span class="tooltiptext" style="font-size:16px">الأجدد</span>--></i></li>
					<i style="font-size:24px" class="fa">&nbsp;</i>
					<i style="font-size:24px" class="fa"><a href="#">&#xf0d8;</a><!--<span class="tooltiptext" style="font-size:16px">الأقدم</span>--></i>
				<i style="font-size:24px" class="fa">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i>

					<li class="placeholder"> 
						<a data-type="all" href="#">All</a> </li> 
					<li data-id="0" class="filter" ><a class="<?php echo $class[0];?>" href="#" data-type="all">الكل</a></li>			
				    <li data-id="1" class="filter" data-filter=".color-1" ><a class="<?php echo $class[1];?>"  href="#" data-type="color-1">انفوغراف</a></li>
					<li data-id="2" class="filter" data-filter=".color-2"><a class="<?php echo $class[2];?>" href="#" data-type="color-2">بوستر</a></li>
					<li data-id="3" class="filter" data-filter=".color-3"><a class="<?php echo $class[3];?>" href="#" data-type="color-2">صور</a></li>
					<li data-id="4" class="filter" data-filter=".color-4"><a class="<?php echo $class[4];?>" href="#" data-type="color-2">فيديو</a></li>
					<li data-id="5" class="filter" data-filter=".color-5"><a class="<?php echo $class[5];?>" href="#" data-type="color-2">فيديوغراف</a></li>
					<li data-id="6" class="filter" data-filter=".color-5"><a id="discard" name="discard" href="#" data-type="color-2">&nbsp;&times;&nbsp;</a></li>
				</ul> <!-- cd-filters -->
					</div> <!-- cd-tab-filter -->
		</div>
    		</div>
...
<form class="row row-cols-lg-auto g-3 align-items-center" id="myform" action="sort_and_filter.php" method="post"> 		<!--<input id="type_id" name="type_id" style="display:none;" value=""></input>-->
